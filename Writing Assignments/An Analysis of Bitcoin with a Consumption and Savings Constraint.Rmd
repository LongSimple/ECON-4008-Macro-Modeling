...
We assume the agent has a subjective discount value of $.85$ and a risk aversion parameter equal to two. After adjusting $\rho$, $\mu$, and $\sigma_e$, the persistence of shock, mean, and variance of *something*, model fails to accurately simulate stock returns with summary statistics equal to those observed in the data. 
